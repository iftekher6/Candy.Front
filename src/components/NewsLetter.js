...
const NewsLetter = ()=>{
    ...
    return(
        <section className="w-[95%] relative sm:max-w-6xl md:max-w-7xl mx-auto bg-ccpurple flex flex-col justify-center box-border items-center p-[52px] gap-5 rounded-lg mt-5 mb-3 overflow-hidden">
