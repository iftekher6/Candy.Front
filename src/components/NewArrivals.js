...
const NewArrivals = ()=>{
    ...
    return(
    <section className='w-[90%] mx-auto sm:max-w-7xl h-[1050px] md:h-[585px] '>
        ...
        <div className='flex flex-col md:flex-row gap-2  h-full md:h-[540px] overflow-hidden'>
         ...
         <div className='flex flex-col w-full md:w-1/2 h-[500px] md:h-full p-3 relative bg-pink-200 rounded-md  overflow-hidden'>
