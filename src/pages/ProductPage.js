...
function ProductPage() {
  ...
  return (
    ...
    <div className='flex flex-col md:mt-2 md:flex-row md:justify-start gap-8 max-w-7xl mx-auto p-6'>
          ...
          <div className='flex flex-col w-full md:w-1/2 md:mt-[25px] gap-10 '>
            ...
            <h1 className='font-[700] text-3xl text-black'>{name}</h1>
            <div className='flex justify-around gap-[100px]'>
              <div className='flex gap-2 justify-center items-center'>
                <span className='line-through text-sm text-[#666666]'>BDT 700</span>
                <span className='text-xl font-[600] text-black'>BDT{price}</span>

              </div>
              <div className='flex gap-3'>
                <span className='text-[#666666]'>1,298 Sold</span>
